...
date: "2026-04-19"
description: "I automated my catering menu selection using Playwright, browser session hijacking, and API reverse engineering, with diet-aware scoring for ulcerative colitis."
